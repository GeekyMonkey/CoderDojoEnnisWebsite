# member-dashboard-ui Specification

## Purpose
Define the signed-in member dashboard shell used for member routes, including a responsive left navigation sidebar, role-based navigation items, and a sidebar footer user menu for theme/language/logout.
## Requirements
